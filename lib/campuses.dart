...
class _CampusesState extends State<Campuses>
  ...
  final firebaseCollection = FirebaseFirestore.instance.collection('Categories');
  ...
  final List<String> _Entertainmentlist = [
    'Anime',
    'Manga',
    'K-Pop',
    'Korean movies',
  ...
  final List<String> _Hustlerslist = [
    'trading',
    'dropshipping',
    'free lancing',
    'marketing',
  ...
  final List<String> _Professionalslist = [
    'Healthcare',
    'Law',
    'Government',
    'Corporate',
  ];
  final List<String> _Familylslist = [
    'Marriage',
    'Mothers',
    'Fathers',
    'Kids',
  ...
  final List<String> _Fitnesslist = [
    'gym',
    'Body Image',
  ];
  final List<String> _Politicslist = [
    'Politics',
  ];
  ...
  void initState() {
    ...
    _items2 = _Religionlist.toList();
    _items3 = _Sportslist.toList();
    _items4 = _Healthlist.toList();
    _items5 = _Entertainmentlist.toList();
    _items6 = _Personallist.toList();
    _items7 = _Politicslist.toList();
    _items8 = _Professionalslist.toList();
    _items9 = _Homelist.toList();
    _items10 = _Hustlerslist.toList();
    _items11 = _Educationlist.toList();
    _items12 = _Eventslist.toList();
    _items13 = _Travellist.toList();
    _items14 = _Sportslist.toList();
    _items15 = _Shoppinglist.toList();
  }
                      ...
                      delegate: SliverChildListDelegate([
                                    ...
                                    children: <Widget>[
                                      ...
                                      Container(
                                        ...
                                        child: IconButton(
                                          ...
                                          //  handleAddTag();
                                            setState(() {
                                              _count++;
                                             // _items2.add(_count.toString());
                                             // _items3.add(_count.toString());
                                      ...
                                      Container(
                                        ...
                                        child: IconButton(
                                          ...
                                          onPressed: () {
                                            setState(() {
                                              // changed from items to items2
                                              _items2 = _Religionlist.toList();
                                              _items2 = _Sportslist.toList();
                                            });
                                          },
                                        ),
                                      ),
                        ...
                        StreamBuilder(
                          stream: FirebaseFirestore.instance.collection('Categories')
                              .orderBy('subCategories',descending: true).snapshots(),
                            ...
                            else if (snapshot.connectionState == ConnectionState.active)
                            {
                              if(snapshot.data!.docs.isNotEmpty){
                                  ...
                                  return ListView.builder(
                                    ...
                                    {
                                      Categories post = Categories.getPost(snapshot, index);

                                      return listViewWidget(post.category, post.subCategories);
                                    },
                                  );
                                }
                              }
...
//     categories.add(CategoriesModel.fromDocument(doc));
//     }
// _items = categories.toList();
//     return Tags(
//     key: _tagStateKey,
//     symmetry: _symmetry,
//     columns: _column,
...
//                     //    _tags1,
  ...
  Widget listViewWidget (String? category, List<String>? subCategories, ) {
    memberuserId = _auth.currentUser?.uid;
    _items = subCategories!.toList();
    return Tags(
      key: _tagStateKey,
      symmetry: _symmetry,
      columns: _column,
  ...
  Widget get _tags4 {
    return Tags(
      ...
      //verticalDirection: VerticalDirection.up, textDirection: TextDirection.rtl,
      heightHorizontalScroll: 60 * (_fontSize / 14),
      itemCount: _items7.length,
      itemBuilder: (index) {
        final item = _items7[index];
