  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(children: [
        Expanded(
          child: CarouselSlider(
            items: [Chewie( controller: _chewieController,),Chewie(controller: _chewieController2,),Image.network( 'https://images.unsplash.com/photo-1520342868574-5fa3804e551c?ixlib=rb-0.3.5&ixid=eyJhcHBfaWQiOjEyMDd9&s=6ff92caffcdd63681a35134a6770ed3b&auto=format&fit=crop&w=1951&q=80', fit: BoxFit.cover, width: 1000.0), IconButton(onPressed: (){
